...
br i1 %trunc_cas_9, label %else_cas_7, label %if_cas_6
...
br label %while_cas_13

while_cas_13:
%trunc_cas_16 = trunc i8 %load_cas_17_y to i1
br i1 %trunc_cas_16, label %block_cas_14, label %cont_cas_15
...
cont_cas_15:
%load_cas_18_y = load i8, i8* %pont_y, align 1
%cas_19 = trunc i8 %load_cas_18_y to i1
ret i1 %cas_19
}
define i32 @main() #0 {
%pont_d = alloca i32, align 4
store i32 5, i32* %pont_d, align 4
%load_cas_20_d = load i32, i32* %pont_d, align 4
ret i32 %load_cas_20_d
}