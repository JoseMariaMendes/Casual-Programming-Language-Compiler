...
%load_cas_10_j = load i32, i32* %pont_j, align 4
%call_cas_9_gun = call i32 @gun(i32 %load_cas_10_j)
ret i32 %call_cas_9_gun
}
define i32 @gun(i32 %s) #0 {
%pont_s = alloca i32, align 4
store i32 %s, i32* %pont_s, align 4
%load_cas_12_s = load i32, i32* %pont_s, align 4
%cas_11_binopexp = add nsw i32 %load_cas_12_s, 3
